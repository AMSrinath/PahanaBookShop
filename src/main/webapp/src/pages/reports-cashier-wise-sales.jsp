...
<%@ page import="pahana.education.model.response.ReportCashierWiseSales" %>
<%
    String pageTitle = "Cashier Wise Sales Report";
%>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-sm">
                            ...
                            <%
                                ...
                                List<ReportCashierWiseSales> itemsList = (List<ReportCashierWiseSales>) request.getAttribute("reportDataList");
                                if (itemsList != null) {
                                    for (int i = 0; i < itemsList.size(); i++) {
                                        ReportCashierWiseSales item = itemsList.get(i);
